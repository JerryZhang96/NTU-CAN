  ...
  <body>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="cnoodlesmenu.php">
          <img
            src="img/cnoodlesmenu.jpg"
            alt="cnoodlesposter"
          />
        </a>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="spicypotmenu.php">
          <img
            src="img/spicypotmenu.jpeg"
            alt="spicypotposter"
          />
        </a>
        <div class="description">Spicy Pot</div>
        <div class="best-seller">
          <h4>Rating: 
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="chickenricemenu.php">
          <img
            src="img/chickenricemenu.jpeg"
            alt="chickenriceposter"
          />
        </a>
        <div class="description">Chicken Rice</div>
        <div class="best-seller">
        <h4>Rating: 
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
