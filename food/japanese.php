  ...
  <nav>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="jnoodlesmenu.php">
          <img
            src="img/jnoodlesmenu.jpg"
            alt="jnoodlesposter"
          />
        </a>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="sushimenu.php">
          <img
            src="img/sushimenu.jpg"
            alt="sushiposter"
          />
        </a>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="curryricemenu.php">
          <img
            src="img/curryricemenu.jpg"
            alt="curryriceposter"
          />
        </a>
        <div class="description">Curry Rice</div>
        <div class="best-seller">
        <h4>Rating: 
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
