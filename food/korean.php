...
<body>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="kricesmenu.php">
          <img
            src="img/kricesmenu.jpg"
            alt="kricesposter"
          />
        </a>
        <div class="description">Korean Rice</div>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="ksoupsmenu.php">
          <img
            src="img/ksoupsmenu.jpg"
            alt="ksoupsposter"
          />
        </a>
        <div class="description">Korean Soups</div>
        <div class="best-seller">
          <h4>Rating: 
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
