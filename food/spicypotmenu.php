...
<body>
    ...
    <nav>
      ...
      ?>
        ...
        <h1>Chinese Spicy Pot Menu</h1>
            <?php
                $result=mysqli_query($conn, "SELECT * FROM products LIMIT 26,3") or die("SELECT * FROM products"."<br/><br/>".mysqli_error($conn));
            ...
            <div class="responsive">
                <div class="foodposter">
                    ...
                    ?><br/>
                    From: <?php echo $row['description']?><br />
                    <b>Price:<b><strong style="color: #f94306">
