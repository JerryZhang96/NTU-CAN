...
<body>
    ...
    <nav>
      ...
      ?>
        ...
        <h1>Chicken Cuisine Menu</h1>
            <?php
                $result=mysqli_query($conn, "SELECT * FROM products LIMIT 20,3") or die("SELECT * FROM products"."<br/><br/>".mysqli_error($conn));
