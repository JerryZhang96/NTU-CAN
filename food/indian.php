...
<body>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="currymenu.php">
          <img
            src="img/currymenu.jpg"
            alt="curryposter"
          />
        </a>
        <div class="description">Indian Curry</div>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="iricesmenu.php">
          <img
            src="img/iricesmenu.jpeg"
            alt="iricessposter"
          />
        </a>
        <div class="description">Indian Rices</div>
        <div class="best-seller">
          <h4>Rating: 
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
    ...
    <div class="responsive">
      <div class="foodposter">
        <a href="naansmenu.php">
          <img
            src="img/naansmenu.jpeg"
            alt="naansposter"
          />
        </a>
        <div class="description">Naans</div>
        <div class="best-seller">
        <h4>Rating: 
            <span class="fa fa-star checked"></span>
            <span class="fa fa-star checked"></span>
