...
<div style="margin:0px auto; width:800px;" >
    <div style="padding-bottom:10px">
        ...
        <?php
            if(isset($username[0])){
                echo '<p style="color: black; font-size: 18px;">Dear '.$username[0].', <strong>Total Sales By Products</strong> are shown below: </p>';
            ...
            <tr>
                <td>
                    Total Sales: </td><td style="color: #e67300; text-align: left;" >S$ <?php echo $sum ;?></td>
                </td></tr>
