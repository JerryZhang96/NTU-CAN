...
<body>
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li class="li active"><a href="checkorder.php">Check Order</a></li>
        <?php 
    ...
    <div>
        <section>
            <h1>Check your booking orders here!</h1>
            <form class="form-signup" action="retrieveorder.php" method="POST">
            <input type="email" name="Email" class="form-control" placeholder="Your Email" required><br>
            <input type="submit" name="submit" class="form-control submit" value="Check Order">
            </form>
        </section>
    </div>
    </header>
